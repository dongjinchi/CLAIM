...
#    pgrowth = Parameter(index=[time,regions])
    ...
    function run_timestep(p, v, d, t)
        ...
        if is_first(t)
            ...
            for r in d.regions
                v.ryg[t, r] = v.taxpar[t, r] * v.co2red[t, r]^2 / v.know[t - 1, r] / v.globknow[t - 1] #cost of emission reduction
            end
            ...
            for r in d.regions
                ...
                v.mitigationcost[t, r] = (p.taxmp[r] * v.ryg[t, r]) * p.income[t, r]
            end
            ...
            for r in d.regions
                globco2 = globco2 + v.emission[t, r]#+ v.emissionwithforestry[t, r]
