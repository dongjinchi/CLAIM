...
# ============================================================================
# 【co2_cycle 组件】FaIR v2.0 四池碳循环：把年度 CO₂ 排放转为大气 CO₂ 浓度。
# 排放按份额 a 进入 4 个衰减寿命不同的储库；寿命乘子 α 随累积吸收量与
# 升温状态动态调整（碳汇饱和正反馈，Millar et al. 2017 iIRF100 参数化，
# 用 g0/g1 常数近似）。输出 co2（ppm）供辐射强迫组件使用。
# ============================================================================
